...
export const BRAND_NAV_ITEMS = [
  ...
  { id: "writing-mechanics", label: "11 Writing & Messaging", href: "#11-writing-mechanics", order: 11 },
  { id: "documents", label: "12 Proposals, Quotations & Documents", href: "#12-documents", order: 12 },
  { id: "presentations", label: "13 Presentations", href: "#13-presentations", order: 13 },
  { id: "email", label: "14 Email", href: "#14-email", order: 14 },
  { id: "meetings", label: "15 Meetings, Calls & Site Visits", href: "#15-meetings", order: 15 },
  { id: "pre-send-checklist", label: "16 Pre-Send / Pre-Say / Pre-Share", href: "#16-pre-send-checklist", order: 16 },
